              ...
              >
                <div>
                  ...
                  <p className="text-neutral-400 text-lg font-medium">
                    Market again to your customers with precise data and
                    analytics
                  </p>
                </div>
              </motion.div>
            ...
            >
              <div className="bg-gradient-to-br from-neutral-900/60 via-neutral-900/40 to-neutral-800/30 backdrop-blur-3xl border border-neutral-700/30 rounded-3xl p-12 relative">
                ...
                <div className="relative z-10 text-center">
                  ...
                  >
                    Advanced remarketing campaigns and customer re-engagement
                    tools are being developed for our premium users. Get ready
                    to reconnect with your audience through precise targeting
                    ...
                    {[
                      {
                        ...
                        description:
                          "Re-engage past customers with personalized campaigns",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        description:
                          "Create targeted promotions based on user behavior",
                      },
                    ].map((feature, index) => (
                      <motion.div
                        key={index}
